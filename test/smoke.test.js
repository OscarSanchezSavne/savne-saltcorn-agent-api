...
assert.ok(urls.includes("/savne-saltcorn-agent-api/actions"));
...
assert.ok(urls.includes("/savne-saltcorn-agent-api/pages/public"));
...
assert.ok(urls.includes("/savne-saltcorn-agent-api/triggers"));
assert.ok(urls.includes("/savne-saltcorn-agent-api/triggers/webhook"));
...
assert.strictEqual(typeof plugin.extension_api.listActionsAndTriggers, "function");
assert.strictEqual(typeof plugin.extension_api.actions, "function");
...
assert.strictEqual(typeof plugin.extension_api.createPublicPage, "function");
assert.strictEqual(typeof plugin.extension_api.createTrigger, "function");
assert.strictEqual(typeof plugin.extension_api.createWebhookTrigger, "function");
...
Promise.resolve(plugin.extension_api.openapi())
  .then((openapi) => {
    ...
    assert.ok(openapi.paths["/savne-saltcorn-agent-api/actions"]);
